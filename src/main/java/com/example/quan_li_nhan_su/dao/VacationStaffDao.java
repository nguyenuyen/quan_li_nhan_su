...
public class VacationStaffDao extends VacationDao{
    ...
    public Staff getInfo(String mail){
        ...
        try {
            ...
            ResultSet rs = ps.executeQuery();
            if (rs.next()){
                return new Staff(rs.getInt("id"), rs.getString("name"), rs.getInt("phone"), rs.getInt("code"), rs.getString("mail"), rs.getInt("id_team"),
